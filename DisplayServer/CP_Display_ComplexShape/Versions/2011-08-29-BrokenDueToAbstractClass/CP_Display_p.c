...
#define PROC_FORMAT_STRING_SIZE   2761                              
...
CINTERFACE_PROXY_VTABLE(45) _IVMotionProxyVtbl = 
{
    &IVMotion_ProxyInfo,
    &IID_IVMotion,
    IUnknown_QueryInterface_Proxy,
...
/* 2648 */	NdrFcShort( 0x18 ),	/* 24 */
/* 2650 */	0x4,		/* Oi2 Flags:  has return, */
			0x2,		/* 2 */
...
#ifndef _ALPHA_
#if !defined(_MIPS_) && !defined(_PPC_)
/* 2694 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
#else
			NdrFcShort( 0x14 ),	/* MIPS & PPC Stack size/offset = 20 */
#endif
#else
...
/* 2732 */	NdrFcShort( 0x26 ),	/* 38 */
#ifndef _ALPHA_
#if !defined(_MIPS_) && !defined(_PPC_)
/* 2734 */	NdrFcShort( 0x14 ),	/* x86 Stack size/offset = 20 */
#else
			NdrFcShort( 0x18 ),	/* MIPS & PPC Stack size/offset = 24 */
#endif
#else
