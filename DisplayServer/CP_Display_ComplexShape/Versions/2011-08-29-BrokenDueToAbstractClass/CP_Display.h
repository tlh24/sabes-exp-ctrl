...
/* at Tue Aug 30 03:47:06 2011
 */
/* Compiler settings for D:\Sabes\Dropbox\2011-LabCode (1)\DisplayServer\CP_Display_ComplexShape\Current\CP_Display.idl:
...
#define IVMotion_UseCircle(This,newVal,iLogID)	\
    (This)->lpVtbl -> UseCircle(This,newVal,iLogID)

#define IVMotion_IsSquare(This,pVal)	\
    (This)->lpVtbl -> IsSquare(This,pVal)

#define IVMotion_UseSquare(This,newVal,iLogID)	\
    (This)->lpVtbl -> UseSquare(This,newVal,iLogID)
