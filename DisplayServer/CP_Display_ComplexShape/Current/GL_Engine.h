...
extern BOOL    g_blnAutoUpdate;  // In this mode, automatically updates every frame (implies blnFrameSync)
...
// UDP-related globals
extern BOOL		g_UDPsetupFlag;
extern int		g_UDPsock; 
extern BOOL		g_UDPready;
extern double	*g_UDPdata;
extern int		g_UDPdataCount;
