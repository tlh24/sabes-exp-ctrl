// VisComplexShape.cpp : Implementation of CVisComplexShape
#include "stdafx.h"
#include "VisServer.h"
#include "VisComplexShape.h"
#include "stdio.h"
#include "math.h"
#include "VisWindow.h"
#include "ComUtils.h"
...
STDMETHODIMP CVisComplexShape::InterfaceSupportsErrorInfo(REFIID riid)
{
...
CVisComplexShape::CVisComplexShape()
{
    int i;
...
CVisComplexShape::~CVisComplexShape()
{
	logToFile((f, "CVisComplexShape is to be deleted\n"));
/*	int i;
	for (i = 0; i < aiTopIndex; ++i) 
	{
...
*/	Show=0;
    ...
    logToFile((f, "CVisComplexShape has been deleted\n"));
}

void CVisComplexShape::updateScrVertices(void)
{
    if(exact){
...
// Stuffs
/*
STDMETHODIMP CVisComplexShape::get_tag(double *pVal)
{
...
STDMETHODIMP CVisComplexShape::get_show(double *pVal)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVisComplexShape::put_show(double newVal)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVisComplexShape::get_pos(VARIANT *pVal)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVisComplexShape::put_pos(VARIANT newVal)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVisComplexShape::get_z(double *pVal)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVisComplexShape::put_z(double newVal)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVisComplexShape::get_errstring(BSTR *pVal)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CVisComplexShape::get_clipped(double *pVal)
{
	*pVal = Clipped;
	return S_OK;
}

STDMETHODIMP CVisComplexShape::get_scale(double *pVal)
{
	*pVal = scale;
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_scale(double newVal)
{
	scale = newVal;
    updateScrVertices();
...
STDMETHODIMP CVisComplexShape::get_angle(double *pVal)
{
	*pVal = angle;
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_angle(double newVal)
{
	angle = newVal;
    updateScrVertices();
...
STDMETHODIMP CVisComplexShape::get_exact(double *pVal)
{
	*pVal = exact;
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_exact(double newVal)
{
	exact = (int)newVal;
...
STDMETHODIMP CVisComplexShape::get_color(VARIANT *pVal)
{
...
STDMETHODIMP CVisComplexShape::put_color(VARIANT newVal)
{
	double *data;
...
STDMETHODIMP CVisComplexShape::get_vertices(VARIANT *pVal)
{
...
STDMETHODIMP CVisComplexShape::put_vertices(VARIANT newVal)
{
	double *data;
...
STDMETHODIMP CVisComplexShape::get_colors(VARIANT *pVal)
{
    VariantFromDoubleArray(getColors(), pVal);
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_colors(VARIANT newVal)
{
	double *data;
	if (VariantToDoubleArray(&data, &newVal)) return E_INVALIDARG;
	setColors(data);
...
STDMETHODIMP CVisComplexShape::get_edgeFlags(VARIANT *pVal)
{
    VariantFromDoubleArray(getEdgeFlags(), pVal);
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_edgeFlags(VARIANT newVal)
{
	double *data;
	if (VariantToDoubleArray(&data, &newVal)) return E_INVALIDARG;
	setEdgeFlags(data);
...
STDMETHODIMP CVisComplexShape::get_indices(VARIANT *pVal)
{
...
STDMETHODIMP CVisComplexShape::put_indices(VARIANT newVal)
{
	double *data;
	if (VariantToDoubleArray(&data, &newVal)) return E_INVALIDARG;
	if (data)
...
STDMETHODIMP CVisComplexShape::get_polygonStipple(VARIANT *pVal)
{
...
STDMETHODIMP CVisComplexShape::put_polygonStipple(VARIANT newVal)
{
	double *data;
	if (VariantToDoubleArray(&data, &newVal)) return E_INVALIDARG;
...
STDMETHODIMP CVisComplexShape::get_lineStipple(double *pVal)
{
	*pVal = lineStipple;
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_lineStipple(double newVal)
{
...
STDMETHODIMP CVisComplexShape::get_lineStippleFactor(double *pVal)
{
	*pVal = lineStippleFactor;
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_lineStippleFactor(double newVal)
{
...
STDMETHODIMP CVisComplexShape::get_lineWidth(double *pVal)
{
	*pVal = lineWidth;
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_lineWidth(double newVal)
{
	lineWidth = newVal;
...
STDMETHODIMP CVisComplexShape::get_pointSize(double *pVal)
{
	*pVal = pointSize;
	return S_OK;
}

STDMETHODIMP CVisComplexShape::put_pointSize(double newVal)
{
	pointSize = newVal;
...
STDMETHODIMP CVisComplexShape::get_drawMode(BSTR *pVal)
{
...
STDMETHODIMP CVisComplexShape::put_drawMode(BSTR newVal)
{
    bool found = false;
    for (int i=0; drawModeStringMap[i].name != NULL; ++i)
    {
...
void
CVisComplexShape::draw()
{
	logToFile((f, "CVisComplexShape Draw\n"));
	if(!Show) return;
...
//			glEdgeFlagPointer(0, arrays[aiEdgeFlags]);
	...
	else if (vertices != 0)
	{
		...
		for (int i=0; i < len2; ++i)
		{
			...
			if (arrays[aiNormals] != 0)
				glNormalPointer(GL_DOUBLE, 0, arrays[aiNormals] + GetLength(arrays[aiNormals], 0) * GetLength(arrays[aiNormals], 1) * i);
			if (arrays[aiColors] != 0)
