// VisComplexObj.h : Declaration of the CVisComplexObj

#ifndef __VISCOMPLEXOBJ_H_
#define __VISCOMPLEXOBJ_H_
...
/////////////////////////////////////////////////////////////////////////////
// CVisComplexObj
class ATL_NO_VTABLE CVisComplexObj :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CVisComplexObj, &CLSID_VisComplexObj>,
	public IDispatchImpl<IVisComplexObj, &IID_IVisComplexObj, &LIBID_VISSERVERLib>,
...
BEGIN_COM_MAP(CVisComplexObj)
	COM_INTERFACE_ENTRY(IVisComplexObj)
	COM_INTERFACE_ENTRY(IDispatch)
	COM_INTERFACE_ENTRY(ISupportErrorInfo)
END_COM_MAP()

DECLARE_REGISTRY_RESOURCEID(IDR_VISCOMPLEXOBJ)
...
//	STDMETHOD(get_texCoords)(/*[out, retval]*/ VARIANT *pVal);
//	STDMETHOD(put_texCoords)(/*[in]*/ VARIANT newVal);
	STDMETHOD(get_colors)(/*[out, retval]*/ VARIANT *pVal);
	STDMETHOD(put_colors)(/*[in]*/ VARIANT newVal);
//	STDMETHOD(get_normals)(/*[out, retval]*/ VARIANT *pVal);
//	STDMETHOD(put_normals)(/*[in]*/ VARIANT newVal);
...
protected:
	...
	float JAC[2][2],ROT[12];    // Jacobian and OpenGL Rotation
