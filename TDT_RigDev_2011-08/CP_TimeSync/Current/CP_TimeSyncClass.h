  ...
  ULONG __stdcall Release() {return InterlockedDecrement(&m_cRef); };
    ...
    *pCountTypeInfo = 1;  
    ...
    HRESULT __stdcall ConnectRP2(BSTR bstInterfaceType, long iDevIdx,
                                 long * piResult );
    HRESULT __stdcall ConnectRX5(BSTR bstInterfaceType, long iDevIdx,
                                 long * piResult );
    HRESULT __stdcall ConnectServer(BSTR bstServerName, long *piResult );

    HRESULT __stdcall GetStatus(long * piStatus);
    HRESULT __stdcall GetDeviceStatus(BSTR bstDeviceName, long * piStatus);
    HRESULT __stdcall GetSysMode(long * piStatus);
    ...
    HRESULT __stdcall GetDeviceSFreq(BSTR bstDeviceName, float * pfSamplingRate );
