...
char * g_szVersion = "CP EyeTrack: Ver 0.01\r\nDecember 7th, 2006\r\nby Sergei Rebrik <rebrik@phy.ucsf.edu>";
...
int g_GetLatestRawCoordinates( double * pdTimeMs, double * pdX, double * pdY ){
  int iIdx;
  IScanData isdTmp;
...
//  if( isdTmp.iRawX == 0 &&  isdTmp.iRawY == 0 ) return 2;
  ...
  * pdX = ((double)isdTmp.iRawX - ISCAN_MIN_X)/ ISCAN_MAX_X; 
  * pdY = ((double)isdTmp.iRawY - ISCAN_MIN_Y)/ ISCAN_MAX_Y;
  return 0;
}
//==============================================
int g_CmdStart(){
