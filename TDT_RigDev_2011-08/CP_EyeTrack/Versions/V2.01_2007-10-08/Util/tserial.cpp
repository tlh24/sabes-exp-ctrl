...
#define PER_CHAR_TIMEOUT_MS   100    // per-char timeout used in read
#define INTER_CHAR_TIMEOUT_MS 100    // between-char timeout used in read
#define PER_READ_TIMEOUT_MS   100    // per-read timeout used in read
...
//  dcb.EvtChar = ;                       // Received Event character
  ...
  // extra per read in ms
  cto.ReadTotalTimeoutConstant = PER_READ_TIMEOUT_MS;     
