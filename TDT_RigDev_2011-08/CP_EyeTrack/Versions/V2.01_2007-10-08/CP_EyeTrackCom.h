...
EXTERN_C const IID IID_IEyeTrack;
    ...
    public:
        ...
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE SetTransformMatrix( 
            /* [in] */ SAFEARRAY __RPC_FAR * saTransform) = 0;
        ...
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetDataLatest( 
            ...
            /* [out] */ SAFEARRAY __RPC_FAR * __RPC_FAR *psaCoord) = 0;
...
#define IEyeTrack_GetTransformMatrix(This,psaTransform)	\
    (This)->lpVtbl -> GetTransformMatrix(This,psaTransform)

#define IEyeTrack_SetTransformMatrix(This,saTransform)	\
    (This)->lpVtbl -> SetTransformMatrix(This,saTransform)
...
#define IEyeTrack_GetDataLatest(This,nFrames,piDataIdx,psaTimeStampMs,psaCoord)	\
    (This)->lpVtbl -> GetDataLatest(This,nFrames,piDataIdx,psaTimeStampMs,psaCoord)

#define IEyeTrack_GetDataBuffered(This,iDataIdx,nFrames,psaTimeStampMs,psaCoord)	\
    (This)->lpVtbl -> GetDataBuffered(This,iDataIdx,nFrames,psaTimeStampMs,psaCoord)
