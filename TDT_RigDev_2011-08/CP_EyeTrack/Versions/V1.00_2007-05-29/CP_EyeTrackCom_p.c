    ...
    /* [out] */ SAFEARRAY __RPC_FAR * __RPC_FAR *psaMatrix)
{
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            NdrUserMarshalUnmarshall( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                      (unsigned char __RPC_FAR * __RPC_FAR *)&psaMatrix,
    ...
    DWORD *_pdwStubPhase)
{
    HRESULT _RetVal;
    MIDL_STUB_MESSAGE _StubMsg;
    SAFEARRAY __RPC_FAR * __RPC_FAR *psaMatrix;
...
NdrStubInitialize(
                     ...
                     &Object_StubDesc,
                     _pRpcChannelBuffer);
    ( SAFEARRAY __RPC_FAR * __RPC_FAR * )psaMatrix = 0;
    RpcTryFinally
        {
        
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IEyeTrack*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> GetTransformMatrix((IEyeTrack *) ((CStdStubBuffer *)This)->pvServerObject,psaMatrix);
        
        *_pdwStubPhase = STUB_MARSHAL;
        
        _StubMsg.BufferLength = 0U + 11U;
        NdrUserMarshalBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                  (unsigned char __RPC_FAR *)psaMatrix,
                                  (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[978] );
    ...
    /* [in] */ SAFEARRAY __RPC_FAR * saMatrix)
{
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            _StubMsg.BufferLength = 0U;
            NdrUserMarshalBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                      (unsigned char __RPC_FAR *)saMatrix,
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        NdrUserMarshalUnmarshall( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                  (unsigned char __RPC_FAR * __RPC_FAR *)&saMatrix,
                                  (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[996],
                                  (unsigned char)0 );
        
        
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IEyeTrack*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> SetTransformMatrix((IEyeTrack *) ((CStdStubBuffer *)This)->pvServerObject,saMatrix);
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IEyeTrack*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> GetIndexLatest((IEyeTrack *) ((CStdStubBuffer *)This)->pvServerObject,plIdx);
    ...
    /* [out] */ SAFEARRAY __RPC_FAR * __RPC_FAR *pafData)
{
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *plIdx = *(( long __RPC_FAR * )_StubMsg.Buffer)++;
            ...
            NdrUserMarshalUnmarshall( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                      (unsigned char __RPC_FAR * __RPC_FAR *)&padTimeStampMs,
                                      (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[1014],
                                      (unsigned char)0 );
            
            NdrUserMarshalUnmarshall( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                      (unsigned char __RPC_FAR * __RPC_FAR *)&pafData,
                                      (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[1014],
                                      (unsigned char)0 );
    ...
    RpcExcept(_StubMsg.dwStubPhase != PROXY_SENDRECEIVE)
        ...
        NdrClearOutParameters(
                         ...
                         ( void __RPC_FAR * )padTimeStampMs);
        NdrClearOutParameters(
                         ( PMIDL_STUB_MESSAGE  )&_StubMsg,
                         ( PFORMAT_STRING  )&__MIDL_TypeFormatString.Format[1010],
                         ( void __RPC_FAR * )pafData);
        _RetVal = NdrProxyErrorHandler(RpcExceptionCode());
        }
    RpcEndExcept
    return _RetVal;
    ...
    DWORD *_pdwStubPhase)
{
    ...
    MIDL_STUB_MESSAGE _StubMsg;
    long nItems;
    SAFEARRAY __RPC_FAR * __RPC_FAR *padTimeStampMs;
    SAFEARRAY __RPC_FAR * __RPC_FAR *pafData;
    long __RPC_FAR *plIdx;
...
NdrStubInitialize(
                     ...
                     _pRpcChannelBuffer);
    ( long __RPC_FAR * )plIdx = 0;
    ( SAFEARRAY __RPC_FAR * __RPC_FAR * )padTimeStampMs = 0;
    ( SAFEARRAY __RPC_FAR * __RPC_FAR * )pafData = 0;
    RpcTryFinally
        {
        if ( (_pRpcMessage->DataRepresentation & 0X0000FFFFUL) != NDR_LOCAL_DATA_REPRESENTATION )
            NdrConvert( (PMIDL_STUB_MESSAGE) &_StubMsg, (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[52] );
        ...
        *_pdwStubPhase = STUB_MARSHAL;
        ...
        NdrUserMarshalBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                  (unsigned char __RPC_FAR *)padTimeStampMs,
                                  (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[1014] );
        
        NdrUserMarshalBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                  (unsigned char __RPC_FAR *)pafData,
                                  (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[1014] );
...
CINTERFACE_PROXY_VTABLE(23) _IEyeTrackProxyVtbl = 
{
    ...
    IEyeTrack_GetIndexLatest_Proxy ,
...
/* 30 */	
			...
			0x2,		/* Alpha Stack size = 2 */
#endif
/* 32 */	NdrFcShort( 0x3ee ),	/* Type Offset=1006 */
/* 34 */	
			0x51,		/* FC_OUT_PARAM */
#ifndef _ALPHA_
			0x1,		/* x86, MIPS & PPC Stack size = 1 */
