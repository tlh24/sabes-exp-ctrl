...
ALL : "$(OUTDIR)\CP_EyeTrack.exe" "$(OUTDIR)\CP_EyeTrack.bsc"
...
"$(INTDIR)\PortTalkGrantIO.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\CP_EyeTrack.res" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\CP_EyeTrackCom.tlb"
	$(RSC) /l 0x409 /fo"$(INTDIR)\CP_EyeTrack.res" /i "./Release" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\CP_EyeTrack.res" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\CP_EyeTrackCom.tlb"
	$(RSC) /l 0x409 /fo"$(INTDIR)\CP_EyeTrack.res" /i "./Debug" /d "_DEBUG" $(SOURCE)
