...
for iFrame = 1:nFrames
  hVMain.StartBatchDraw;
  hVMain.ScaleGroup(1,0.999);
  hVMain.ScaleGroup(2,1.001);
  hVMain.FinishBatchDraw;
end
...
for iFrame = 1:nFrames
  hVMain.StartBatchDraw;
  hVMain.ScaleGroup(1,1/0.999);
  hVMain.ScaleGroup(2,1/1.001);
  hVMain.FinishBatchDraw;
end
...
for iFrame = 1:nFrames
  hVMain.StartBatchDraw;
  hVMain.MoveGroup(1,[0.5 0.5]);
  hVMain.MoveGroup(2,[-0.5 -0.5]);
  hVMain.FinishBatchDraw;
end
