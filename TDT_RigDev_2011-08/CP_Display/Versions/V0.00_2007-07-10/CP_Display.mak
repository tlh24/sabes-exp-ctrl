...
"$(INTDIR)\CP_Display.obj"	"$(INTDIR)\CP_Display.sbr" : $(SOURCE) "$(INTDIR)" ".\CP_Display.h" ".\CP_Display_i.c"
...
"$(INTDIR)\CP_Display.res" : $(SOURCE) "$(INTDIR)" ".\CP_Display.tlb"
	$(RSC) $(RSC_PROJ) $(SOURCE)
...
"$(INTDIR)\GL_Engine.obj"	"$(INTDIR)\GL_Engine.sbr" : $(SOURCE) "$(INTDIR)" ".\CP_Display.h"
...
"$(INTDIR)\VDisk.obj"	"$(INTDIR)\VDisk.sbr" : $(SOURCE) "$(INTDIR)" ".\CP_Display.h"


SOURCE=.\VMain.cpp

"$(INTDIR)\VMain.obj"	"$(INTDIR)\VMain.sbr" : $(SOURCE) "$(INTDIR)" ".\CP_Display.h"


SOURCE=.\VMouse.cpp

"$(INTDIR)\VMouse.obj"	"$(INTDIR)\VMouse.sbr" : $(SOURCE) "$(INTDIR)" ".\CP_Display.h"
...
"$(INTDIR)\VPolygon.obj"	"$(INTDIR)\VPolygon.sbr" : $(SOURCE) "$(INTDIR)" ".\CP_Display.h"


SOURCE=.\VText.cpp

"$(INTDIR)\VText.obj"	"$(INTDIR)\VText.sbr" : $(SOURCE) "$(INTDIR)" ".\CP_Display.h"
