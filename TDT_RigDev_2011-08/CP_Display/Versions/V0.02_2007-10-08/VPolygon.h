...
// polygon-specific methods
  STDMETHOD(GetVertices)(SAFEARRAY ** ppsaVertices);
  STDMETHOD(SetVertices)(SAFEARRAY * psaVertices, long iLogID);
  STDMETHOD(GetTexture)(SAFEARRAY ** ppsaTexture,
                        long * pnPixelsW,
                        long * pnPixelsH,
                        double * pdTexturePhysWidth );
  STDMETHOD(SetTexture)(SAFEARRAY * psaTexture,
