...
// in mm
#define RAW_MIN_X 0.0f
#define RAW_MAX_X 800.0f

#define RAW_MIN_Y -900.0f
...
char * g_szVersion = "CP_OptoTrack: Ver 0.02 October 23rd, 2008";
...
// From Optotrack.h we use this structure to output coordinates/angles
