...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\CP_OptoTrack.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\CP_OptoTrack.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=opto\pdi.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib Winmm.lib opto\oapi.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\CP_OptoTrack.pdb" /machine:I386 /out:"$(OUTDIR)\CP_OptoTrack.exe" /libpath:"Opto" 
LINK32_OBJS= \
...
ALL : "$(OUTDIR)\CP_OptoTrack.exe" "$(OUTDIR)\CP_OptoTrackCom.tlb" "$(OUTDIR)\CP_OptoTrack.bsc"
...
"$(INTDIR)\ReadingTimer.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "CP_OptoTrack - Win32 Debug"


"$(INTDIR)\ReadingTimer.obj"	"$(INTDIR)\ReadingTimer.sbr" : $(SOURCE) "$(INTDIR)"
