...
CINTERFACE_PROXY_VTABLE(27) _ILibertyTrackProxyVtbl = 
{
    &IID_ILibertyTrack,
...
/* 50 */	
			...
			0x2,		/* Alpha Stack size = 2 */
#endif
/* 52 */	NdrFcShort( 0x3f2 ),	/* Type Offset=1010 */
...
/* 56 */	
			...
			0x0,		/* Alpha Stack size = 0 */
#endif
/* 58 */	NdrFcShort( 0x3e8 ),	/* Type Offset=1000 */
...
/* 62 */	
			...
			0x2,		/* Alpha Stack size = 2 */
#endif
/* 64 */	NdrFcShort( 0x28 ),	/* Type Offset=40 */
