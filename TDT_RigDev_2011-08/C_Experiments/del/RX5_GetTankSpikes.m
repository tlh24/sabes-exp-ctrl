function SpikeArray = RX5_GetTankSpikes(strTank, iBlock, dGlobRecStartTS)
% function SpikeArray = GetTankSpikes(strTank, iBlock, dGlobRecStartTS )
%
...
%   dGlobRecStartTS - global timestamp (in seconds) for the RecordingStart event
%
% OUTPUT:
...
c0 = dGlobRecStartTS - dRecStartTS;
