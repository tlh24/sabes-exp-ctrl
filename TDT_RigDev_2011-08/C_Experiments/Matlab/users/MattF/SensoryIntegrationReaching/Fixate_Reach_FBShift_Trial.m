function dat = Fixate_Reach_FBShift_Trial(dat)
%
%  MF October, 2007.
%
...
%%%  Tone signals next phase. Continue holding.  (Shifted) FB on.
...
%%  - - - - - - - - PHASE 5 - - - - - - - - - - - -
%%%             REACHING PHASE
%%%  Begin reach to Reach Target.  Vis FB off.  Maintain Fixation for some proportion
%%%  of the reach.  Continue reach with free-viewing.  No terminal FB.
%%%
