...
hRightHandArrowField = createArrowField(Params.NarrowsX,Params.NarrowsY,Params.wsBounds, ...
                                       Params.rightHandArrowFieldZ, Params.visServerIP);
% invokeMultiVisObjects(hRightHandArrowField,'SetZ',Params.rightHandArrowFieldZ);
% %%%%

%       Create vis blur objects
%hFng.SetColor( dat.visBlur.RGB.*dat.visBlur.bright);
